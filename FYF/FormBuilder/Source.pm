...
# Use "perldoc FYF::FormBuilder::Source" to read full documentation.

package FYF::FormBuilder::Source;

=head1 NAME

FYF::FormBuilder::Source - Source adapters for FormBuilder

=head1 SYNOPSIS

    # Define a source adapter

    package FYF::FormBuilder::Source::Whatever;
...
the C<FYF::FormBuilder::Source::File> layout. Like with the C<template>
...
accepted types are:
    ...
    File  -  FYF::FormBuilder::Source::File
...
L<FYF::FormBuilder>, L<FYF::FormBuilder::Source::File>,
