...
# Use "perldoc FYF::FormBuilder::Messages" to read full documentation.

package FYF::FormBuilder::Messages::locale;

=head1 NAME

FYF::FormBuilder::Messages::en_US - English (default) messages for FormBuilder

=head1 SYNOPSIS

    use FYF::FormBuilder;

    my $form = FYF::FormBuilder->new(messages => 'auto');
...
our %MESSAGES = (
    ...
    js_invalid_start      => '%s errores fueron encontrados:',
    js_invalid_end        => 'Corrija estos errores para continuar.',

    js_invalid_input      => '- Valor no válido para el campo "%s"',
    js_invalid_select     => '- Seleccione una opción de la lista "%s"',
    js_invalid_multiple   => '- Select one or more options from the "%s" list',
    js_invalid_checkbox   => '- Check one or more of the "%s" options',
    js_invalid_radio      => '- Elija una opción en "%s"\n',
    js_invalid_password   => '- Valor no válido para el campo "%s"',
    js_invalid_textarea   => '- El campo "%s" es requerido',
    js_invalid_file       => '- Elija un archivo para el campo "%s"',
...
option:
     ...
     my $form = FYF::FormBuilder->new(messages => ':en_US');
