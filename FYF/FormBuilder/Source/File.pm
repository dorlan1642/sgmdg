...
# Use "perldoc FYF::FormBuilder::Source::File" to read full documentation.

package FYF::FormBuilder::Source::File;

=head1 NAME

FYF::FormBuilder::Source::File - Initialize FormBuilder from external file
...
=head1 SYNOPSIS
    ...
    my $form = FYF::FormBuilder->new(source => 'form.conf');
...
sub parse {
    ...
    $FYF::FormBuilder::Util::DEBUG ||= $self->{debug} if ref $self;
...
EOH
    ...
    return FYF::FormBuilder->new(%$form1);
}
...
into C<FYF::FormBuilder>, which calls this module.
...
This creates a new C<FYF::FormBuilder::Source::File> object.

    my $source = FYF::FormBuilder::Source::File->new;
...
be passed directly into C<FYF::FormBuilder>:

    my %conf = $source->parse('myform.conf');
    my $form = FYF::FormBuilder->new(%conf);
...
L<FYF::FormBuilder>, L<Text::FormBuilder>
