...
package FYF::FormBuilder::Field;

=head1 NAME

FYF::FormBuilder::Field - Base class for FormBuilder fields
...
=head1 SYNOPSIS
    ...
    my $f = FYF::FormBuilder::Field->new($form, name => 'whatever');
