      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="tab-pane show active" id="recipes-gral" role="tabpanel" aria-labelledby="users-gral-tab">
            ...
            <form action="./php/membersNew.php" class="" enctype="multipart/form-data" id="formulario" method="POST" name="memebers"
               role="form">
              <div class="form-layout form-layout-3">
                <div class="row no-gutters">
                  ...
                  <div class="col-md-6 mg-t--1 mg-md-t-0">
                    <div class="form-group mg-md-l--1">
                      <label class="title">El nombre para este miembreo <span class="tx-danger">*</span></label>
                  ...
                  <div class="col-md-6 mg-t--1 mg-md-t-0">
                    <div class="form-group mg-md-l--1">
                      <label class="title">El titulo para este miembro <span class="tx-danger">*</span></label>
                  ...
                  <div class="col-md-6 mg-t--1 mg-md-t-0">
                    <div class="form-group mg-md-l--1">
                    <label class="title">Seleccione imagen para este miembro, la imagen deve tener relacion de aspecto 1:1 (cuadroado) <span class="tx-danger">*</span></label>
                  ...
                  ?>
                    ...
                    <div class="form-group mg-md-l--1">
                      <label class="title">El nombre para este miembreo <span class="tx-danger">*</span></label>
                      <input class="form-control" colmd="6" id="name" name="name" type="text" value="" spellcheck="false">
                  ...
                  <div class="col-md-6 mg-t--1 mg-md-t-0">
                    <div class="form-group mg-md-l--1">
                      <label class="title">El resumen para este miembro <span class="tx-danger">*</span></label>
                      <input class="form-control" colmd="6" id="resume" name="resume" type="text" value="" spellcheck="false">
                ...
                <div class="form-layout-footer bd pd-20 bd-t-0">
                  ...
                  <a href="members.php" class="btn btn-outline-secondary"><i class="icon ion-arrow-left-a"></i> Regresar</a>
