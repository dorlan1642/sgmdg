  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          help: {
              ...
              'redo': 'Rehace el ultimo comando',
              'tab': 'Detectable',
              'untab': 'Indetectable',
              'bold': 'Establecer un estilo audaz',
              'italic': 'Establecer un estilo de cursiva',
              'underline': 'Establecer un estilo de subrayado',
              'strikethrough': 'Establecer un estilo tachado',
              'removeFormat': 'Limpiar un estilo',
              'justifyLeft': 'Establecer alinear a la izquierda',
              'justifyCenter': 'Establecer alineación central',
              'justifyRight': 'Establecer alinear a la derecha',
              'justifyFull': 'stablecer alineación completa.',
              'insertUnorderedList': 'Alternar lista desordenada',
              'insertOrderedList': 'Alternar lista ordenada',
              'outdent': 'Vencido en el párrafo actual',
              'indent': 'Sangría en el párrafo actual',
              ...
              'linkDialog.show': 'Mostrar diálogo de enlace'
          },
          history: {
              undo: 'Deshacer',
              redo: 'listo'
          ...
          specialChar: {
              ...
              select: 'Seleccione caracteres especiales'
          }
      }
  });
